...
@property (nonatomic, weak) IBOutlet UIBarButtonItem *btnOK;
...
- (void) loadView
{
    ...
    // NSString *localeIdentifier = [[Localized prefferedLocalization] isEqualToString: @"sr"] ? @"sr-Latn" : [Localized prefferedLozalization];
